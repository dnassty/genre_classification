...
def go(config: DictConfig):
    ...
    if "preprocess" in steps_to_execute:
        ...
        _ = mlflow.run(
            ...
            parameters={
                ...
                "artifact_description": "Data after preprocessing applied."
            },
        )
    ...
    if "random_forest" in steps_to_execute:
        ...
        _ = mlflow.run(
            ...
            "main",
            parameters={
                "train_data": "genre_train.csv:latest",
                "model_config": config["random_forest_pipeline"],
                "export_artifact": config["export_artifact"],
                "random_seed": config["data"]["random_state"],
                "val_size": config["data"]["val_siz"],
                "stratify": config["data"]["stratify"]
            },
        )
    ...
    if "evaluate" in steps_to_execute:
        ...
        _ = mlflow.run(
            ...
            parameters={
                ...
                "test_data": "genre_test.csv:latest",
            },
        )
